  ...
  return (
    <>
      ...
      <div className="space-y-3">
        <h1 className="text-green-400">
          Estilizando código com ReactSyntaxHighlighter
        </h1>
        <p>
    ...
    `}
        ...
        <p>
          ...
          react-syntax-highlighter/dist/esm/styles/hljs para HLJS e
          react-syntax-highlighter/dist/esm/styles/prism para PRISM
        </p>
        <h2 className="text-green-400">Exemplos de styles:</h2>
        <p>{`import { dracula } from "react-syntax-highlighter/dist/esm/styles/prism";`}</p>
        <SyntaxHighlighter language="javascript" style={dracula}>
          {code}
        </SyntaxHighlighter>
        <p>{`import { coldarkCold } from "react-syntax-highlighter/dist/esm/styles/prism";`}</p>
        <SyntaxHighlighter language="javascript" style={coldarkCold}>
          {code}
        </SyntaxHighlighter>
        <p>{`import { okaidia } from "react-syntax-highlighter/dist/esm/styles/prism";`}</p>
        <SyntaxHighlighter language="javascript" style={okaidia}>
          {code}
        </SyntaxHighlighter>
        <p>{`import { a11yDark } from "react-syntax-highlighter/dist/esm/styles/prism";`}</p>
        <SyntaxHighlighter language="javascript" style={a11yDark}>
          {code}
        </SyntaxHighlighter>
        <p>{`import { cb } from "react-syntax-highlighter/dist/esm/styles/prism";`}</p>
